(() => {
  ...
  // Scenario-specific replies for cards that may pause on RESPONSE.
  // These are intentionally tied to exact IDs so a persona fallback can never
  // answer a different situation just because it is the same character.
  const exact = {
    'P06-08': [
      '他回：「好，我放管理室。妳有空再拿就好。」',
